...
parser.add_argument('--arg_model', type=str, default='/media/keithlin/480172DF7546C7BF/GNN/standard_2D_10k_epochs=250_batch=100_workers=4_1668718872')
...
image_dir = osp.join(model_path, eval_dir_name, f'_images/{eval_conditions[0]}')
